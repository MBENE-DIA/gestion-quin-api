...
import ut.set.sn.security.JwtUtil;
import ut.set.sn.service.JwtResponse;
import ut.set.sn.service.UserService;
...
private final UserService userService;
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest)
		...
		return ResponseEntity
				.ok(new JwtResponse(token, user.getId(), user.getPassword(), user.getEmail(), user.getRole() ));
	}
